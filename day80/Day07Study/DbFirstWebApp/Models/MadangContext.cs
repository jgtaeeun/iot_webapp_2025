...
public partial class MadangContext : DbContext
{
    public MadangContext()
    {
    }

    public MadangContext(DbContextOptions<MadangContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseMySQL("Server=localhost;Database=madang;Uid=root;Pwd=12345;Charset=utf8;");
